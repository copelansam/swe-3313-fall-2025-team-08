...
2. Build the Application:
   - You will now want to navigate to the application's source folder (swe-3313-fall-2025-team-08) in the CLI.
   - You must build the application before you can try executing it. you can do this by running `mvn clean install` in your CLI.
   - This will handle all of the application's dependencies and gets the application into a state where all resources are ready to run the application.
